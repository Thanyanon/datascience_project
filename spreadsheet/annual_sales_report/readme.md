...
พบว่า
  ...
  - *Product column:* สีเดียวกันหมายถึงเป็น PO เดียวกัน โดย 1 rows มี Qty ของ product ชนิดนั้นมากกว่า 1 Qty โดยไม่สามารถรวม Qty เข้าด้วยกันได้ เพราะว่าวันที่ส่งของของแต่ละตัวอาจจะไม่ตรงกัน
